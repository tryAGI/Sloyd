...
namespace Sloyd
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Sloyd.AutoSDKRetryOptions Retry { get; set; } = new global::Sloyd.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Sloyd.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Sloyd.IAutoSDKHook>();
        ...
        public global::Sloyd.AutoSDKClientOptions AddHook(
            global::Sloyd.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Sloyd.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Sloyd.AutoSDKClientOptions UseAuthorizationProvider(
            global::Sloyd.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Sloyd.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Sloyd.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Sloyd.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Sloyd.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Sloyd.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Sloyd.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Sloyd.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Sloyd.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Sloyd.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Sloyd.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Sloyd.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Sloyd.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Sloyd.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Sloyd.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Sloyd.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Sloyd.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Sloyd.AutoSDKClientOptions clientOptions,
            global::Sloyd.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Sloyd.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Sloyd.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Sloyd.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Sloyd.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Sloyd.IAutoSDKHook, global::Sloyd.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Sloyd.AutoSDKHookContext context)
        {
